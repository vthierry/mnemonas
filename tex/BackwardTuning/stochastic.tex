...
\eqline{\min_{\hat{x}_n(t)} \frac{1}{2} \, \sum_{nt} \|\hat{x}_n(t) - x_n(t)\|^2 + \sum_k \lambda_k \left[\bar{\Omega}_{k} - \frac{1}{T-\tau_k} \sum_t \omega_k(t)\right]}
...
\eqline{\begin{array}{rcl}
  \hat{x}_n(t) &\leftarrow& x_n(t) + \sum_k \frac{1}{T-\tau_k} \, \lambda_k \, \sum_t \partial_{\bf x} \omega_k(t) \\
  \lambda_k &\simeq& \left[ \frac{1}{T-\tau_k} \, \sum_t \partial_{\bf x} \omega_{k'}(t) \, \partial_{\bf x} \omega_{k''}(t)^T \right]^{\dagger} \, \left[\bar{\Omega}_{k} - \frac{1}{T-\tau_k} \sum_t \omega_k(t)\right] \\
\end{array}}
