...
bool *Density::booleans(unsigned int size, unsigned int count)
{
  assume(count <= size, "illegal-argument", "in Density::booleans: uncoherent count = %d > size = %d", count, size);
